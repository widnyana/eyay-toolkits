...
what you produce when you apply [Design Thinking](method.md) to something, and
it is written in [Graph Protocol](protocol.md) notation.
...
See the end of [protocol.md](protocol.md) for a complete, non-TS worked
